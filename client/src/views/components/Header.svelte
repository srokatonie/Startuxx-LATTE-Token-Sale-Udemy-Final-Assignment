    ...
    <div class="flex items-center h-16">
      <div class="flex items-center w-full justify-between">
        <div class="flex flex-row">
          <div class="text-white mr-0.5">
            <svg class="w-11 h-11" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
          </div>
          <div class="flex-col uppercase text-white">
            <div class="text-md font-bold">Startuxx</div>
            <div class="text-xs">LATTE Token Sale</div>
          </div>
        </div>
        <div class="ml-10 flex space-x-4 flex-row items-center">
          ...
          <a href="/faq" class:bg-gray-900="{currentRoute.name == '/faq'}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium flex flex-row items-center">
